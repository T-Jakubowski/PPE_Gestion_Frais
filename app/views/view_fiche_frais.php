...
<body>
    ...
    <br>
    <?php if ($ficheFrais->getDate() != date("Y-m-01") || $ficheFrais->getEtat() == 'Validée' || $ficheFrais->getEtat() == 'Remboursée' || $permission_comptable) {
    } else { ?>
        <div class="container">
    ...
    <form id="selectUser" method="post" action="/fiche_frais/affiche">
        ...
        <?php if ($permission_manage == true) {  ?>
            <select id="desUsers" name="desUsers" <?php if ($userSelected == true) {
                                                        echo 'disabled';
                                                    } ?>>
                ...
                <tr>
                    ...
                    <?php if ($ficheFrais->getDate() != date("Y-m-01") || $ficheFrais->getEtat() == 'Validée' || $ficheFrais->getEtat() == 'Remboursée' || $permission_comptable) {
                        ...
                        <td><button id="<?php $id; ?>" onclick="Edit('<?php echo $id; ?>')" type="button" class="btn btn-outline-info" data-bs-toggle="modal" data-bs-target="#editLigneModal"><img class="fit-picture" src="/img/edit_black_24dp.svg" alt="edit"></button>
                            <button id="<?php $id; ?>" onclick="ConfirmDelete('<?php echo $id; ?>')" type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#confirmDeleteLigneModal"><img class="fit-picture" src="/img/delete_black_24dp.svg" alt="delete"></button>
                        </td>
                    <?php }
                        if ($permission_comptable) { ?>
                        <td><button id="<?php $id; ?>" onclick="Edit('<?php echo $id; ?>')" type="button" class="btn btn-outline-info" data-bs-toggle="modal" data-bs-target="#editLigneModal"><img class="fit-picture" src="/img/edit_black_24dp.svg" alt="edit"></button>
